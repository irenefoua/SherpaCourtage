...
<body>
	...
	<div style="position: absolute; width: 320px; height: 300px; top:0; bottom:0; left:0; right: 0; margin: auto;">
 	<fieldset style="background-color: threedlightshadow; border-radius: 6px 6px 6px 6px;">
		<h3 style="text-align: center; background-color: #F7230C; color: white;">CONNEXION</h3>
