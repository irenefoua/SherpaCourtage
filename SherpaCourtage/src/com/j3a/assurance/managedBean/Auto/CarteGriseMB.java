		...
		public void setOutputNbrTran(OutputLabel outputNbrTran) {
		 ...
		 public List<SousCatVehicule> getCatVehiList() {
				if(CatVehiList.isEmpty()){
					...
					I.setLibelleSousCatVehicule("V�hicule de Location");
					Categorie catI = new Categorie();
					catI.setCodeCategorie("8");
					catI.setLibelleCategorie("V�hicule de Location");
					I.setCategorie(catI);
					I.setTarif_1("TARIF8");
					I.setTarif(tarif8);
					CatVehiList.add(I);
					...
					K.setLibelleSousCatVehicule("V�hicule sp�ciaux");
					Categorie catK = new Categorie();
					catK.setCodeCategorie("10");
					catK.setLibelleCategorie("V�hicule sp�ciaux");
					K.setCategorie(catK);
